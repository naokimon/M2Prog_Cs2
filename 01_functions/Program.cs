...
class Program2
{
    ...
    static void Main(string[] args)
    {
        ...
        Program2 program = new Program2(); // We hebben een variable gemaakt voor de class program. De function die we gebruiken heet Run();. De return type van de function is nu nog niks omdat, de function nog niet aangemaakt is.
        program.Run(); 
    }
